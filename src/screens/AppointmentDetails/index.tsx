      ...
      >
        <View style={styles.bannerContent}>
          ...
          <Text style={styles.subtitle}>
            É hoje que vamos botar fogo em tudo
          </Text>
        </View>
      </ImageBackground>
